...
const Home = () => {
    ...
    return (
        <>
            <div className="bg-black/90 flex flex-col md:flex-row min-h-[calc(100vh-8.6rem)] px-6 md:px-12 py-10 md:py-20 text-white">
                <div
                    className={`
                ...
                >
                    <img
                        src={Image}
                        alt="Profile"
                        className="w-40 h-40 md:w-64 md:h-64 rounded-full border-2 border-purple-700 p-2 object-cover"
                    />
                </div>
